...
欢迎给我们 [提交BUG](https://github.com/automatically/front-native/issues)

### 需求提交

用户可以通过 Issue 留言提交需求，不承诺每一个需求我们都会实现，但承诺每一个需求我们都会认真考虑。

### 贡献代码

每一位自愿开发者都可以参与进来和我们一同开发，有兴趣可以@阿虫 qq：603227937 或者 603227937@qq.com
